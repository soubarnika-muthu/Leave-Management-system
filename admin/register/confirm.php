...
if(strtotime($doj) > time())
	{
		$errmsg.=" Date Of Birth cannot be a future date..."; 
	}
...
if(!empty($errmsg))
...
else
	{
		...
		if ($conn->query($sql) === TRUE) {
			...
			echo "Student Name : ".$empname."<br/>";
			echo "Department : ".$dept."<br/>";
			echo "Email id : ".$mailid."<br/>";
			echo "Date Of Birth : ".$doj."<br/>";
			echo "Year Of Study : ".$designation."<br/>";
			echo "Day-Scholar/Hosteler : ".$emptype." ; ".$empfee."<br/>";
